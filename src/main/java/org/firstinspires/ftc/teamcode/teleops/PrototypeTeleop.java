...
@TeleOp(name = "ProtoTeleopn", group = "Robot")
...
//    private YawPitchRollAngles cameraOrientation = new YawPitchRollAngles(AngleUnit.DEGREES, 0, -90, 0, 0);
    ...
    public void runOpMode() {
        ...
        ServoImplEx hood = hardwareMap.get(ServoImplEx.class, "hood");
...
//        telemetry.update();
        ...
        while (!isStopRequested() && opModeIsActive()) {
            ...
            servoPosition = Range.clip(servoPosition, 0.01, 0.99); // Clip *after* the change
            hood.setPosition(servoPosition);
...
//            telemetry.update();
            ...
            telemetry.addLine(String.format("Motor: %f", flyPower));
            telemetry.addLine(String.format("Hood position: %f", servoPosition));
            telemetry.update();
